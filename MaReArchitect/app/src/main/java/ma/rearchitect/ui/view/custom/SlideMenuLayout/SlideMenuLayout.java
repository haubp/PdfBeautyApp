...
public class SlideMenuLayout extends ViewGroup implements SlideMenuAction {
    ...
    private opswat.com.view.custom.SlideMenuLayout.OnSlideChangedListener mSlideChangedListener;
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, opswat.com.R.styleable.SlideMenuLayout);
        mSlideMode = ta.getInteger(opswat.com.R.styleable.SlideMenuLayout_slideMode, SLIDE_MODE_NONE);
        mSlidePadding = (int) ta.getDimension(opswat.com.R.styleable.SlideMenuLayout_slidePadding, screenWidth / 4);
        mSlideTime = ta.getInteger(opswat.com.R.styleable.SlideMenuLayout_slideTime, 700);
        mParallax = ta.getBoolean(opswat.com.R.styleable.SlideMenuLayout_parallax, true);
        mContentAlpha = ta.getFloat(opswat.com.R.styleable.SlideMenuLayout_contentAlpha, 0.5f);
        mContentShadowColor = ta.getColor(opswat.com.R.styleable.SlideMenuLayout_contentShadowColor,
                Color.parseColor("#000000"));
        mContentToggle = ta.getBoolean(opswat.com.R.styleable.SlideMenuLayout_contentToggle, false);
        mAllowDragging = ta.getBoolean(opswat.com.R.styleable.SlideMenuLayout_allowDragging, true);
        ta.recycle();
    }
