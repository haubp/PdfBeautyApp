...
final public class SharedPrefsUtils {
    ...
    public static boolean setQueuePreference(Context context, String key, Queue<String> value) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences != null) {
            SharedPreferences.Editor editor = preferences.edit();
            Gson gson = new Gson();
    ...
    public static Queue<String> getQueuePreference(Context context, String key) {
